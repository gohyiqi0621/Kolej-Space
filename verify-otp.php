<?php
session_start();
require 'vendor/autoload.php'; // Assuming SendGrid is installed via Composer

if (!isset($_SESSION['otp']) || !isset($_SESSION['email']) || !isset($_SESSION['otp_expiry'])) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (time() > $_SESSION['otp_expiry']) {
        ...
        $success = "OTP verified successfully. Please proceed to reset your password.";
        header("Location: reset-password.php"); // Redirect to password reset page
        exit();
    } else {
                    ...
                    <div class="col-xl-8">
                        <div class="sign-in-items">
                            <div class="title text-center">
                                <h2 class="wow fadeInUp">Verify OTP</h2>
                            </div>
                            <form action="verify-otp.php" id="verify-otp-form" method="POST">
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-12">
                                        <div class="form-clt style-2">
                                            <span>Enter OTP *</span>
                                            <input type="text" name="otp" id="otp" placeholder="Enter the OTP sent to your email" value="" required>
                                        </div>
                                    </div>
                                    <div></div>
