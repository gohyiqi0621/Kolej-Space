...
<form action="auth.php" id="contact-form" method="POST">
    <div class="row g-4">
        <div class="col-lg-12">
            <div class="form-clt">
                <span>Name *</span>
                <input type="text" name="name" id="name12" placeholder="Name" required>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-clt">
                <span>Email Address *</span>
                <input type="email" name="email" id="email3" placeholder="Email Address" required>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-clt">
                ...
                <select name="course_code" required>
                    <span><option value="">-- Select Course --</option></span>
        ...
        <div class="col-lg-12">
            <div class="from-cheak-items style-2">
    ...
    const emailInput = document.getElementById('email3') || document.getElementById('name');
    const passwordInput = document.getElementById('password');
    const confirmPasswordInput = document.getElementById('confirm-password');
    const errorContainer = document.createElement('div');
    errorContainer.className = 'error-message text-danger text-center mt-2';
    form.insertBefore(errorContainer, form.firstChild);

    // Check for server-side error in URL
    const urlParams = new URLSearchParams(window.location.search);
    const serverError = urlParams.get('error');
    const successMessage = urlParams.get('success');
    if (serverError) {
        errorContainer.textContent = serverError;
    } else if (successMessage) {
        errorContainer.className = 'success-message text-success text-center mt-2';
